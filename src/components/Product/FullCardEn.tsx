...
function FullCardEn({ product }: ProductTypeProps) {
      ...
      <div className='card-un'>
        ...
        <div className="card-un__main">
          ...
          <div className="card-un__advantages">
            ...
            <div dangerouslySetInnerHTML={{ __html: product.advantages_en }}></div>
          </div>
        </div>
        <div className="card-un__composition" >
          ...
          <div dangerouslySetInnerHTML={{ __html: product.composition_en }}></div>
        </div>
        <div className="card-un__rate" >
          <h4>
            {t('rate')}
          </h4>
          <div dangerouslySetInnerHTML={{ __html: product.rate_en }}></div>
        </div>
      </div>
    );
  }
